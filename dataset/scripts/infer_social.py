...
BSKY_BLACKLIST = {
    ...
    "santiago-abascal.bsky.social",  # parodia, no es la cuenta real
    # PP/VOX: personas distintas con nombre similar
    "rodriguez-pose.bsky.social",    # economista de la LSE, no el diputado de VOX
    "javierdenoriega.bsky.social",   # director de empresa de investigación, no el diputado PP
    "franciscocamacho.bsky.social",  # militante de Podemos, no el diputado PP
    "miriamrgarcia.bsky.social",     # química/matemática, no la diputada PP
    "mpatriciom.bsky.social",        # profesora en Toulouse, no la diputada PP
    "rosaromeroadh.bsky.social",     # concejala de Más Madrid, no la diputada PP
    "rrenrique.bsky.social",         # secretario de CCOO, no el diputado PP
    "martinvtorres.bsky.social",     # político de Illinois (EEUU), no el diputado PP
    # Cuentas fantasma creadas en nov 2024 (boom Bluesky), 0 posts, sin actividad real
    "cantabriaes.bsky.social",       # Gobierno de Cantabria — fantasma
    "lariojaorg.bsky.social",        # Gobierno de La Rioja — fantasma
    "jcyl.bsky.social",              # Junta de Castilla y León — fantasma
    "gobiernomelilla.bsky.social",   # Ciudad de Melilla — fantasma
    "generalitat.bsky.social",       # Generalitat Valenciana — fantasma
    "aeropuertosaena.bsky.social",   # Aena — fantasma; no se ha encontrado cuenta oficial
    "seacabolafiesta.bsky.social",   # Se Acabó La Fiesta — parodia (bio: "Pero empiezan los chollos")
    "pilarcalvo13.bsky.social",      # Calvo Gómez, Pilar — 3 posts, sin bio, no verificable
    # handles incorrectos de universidades (los correctos están en el Excel)
    "usal.bsky.social",              # cuenta abandonada; la oficial es usaloficial.bsky.social
    "upc.bsky.social",               # cuenta abandonada; la oficial es upc.edu
    "upv.bsky.social",               # cuenta abandonada; la oficial es upv.es
    "uned.bsky.social",              # cuenta abandonada; la oficial es uneduniv.bsky.social
    "uc3m.bsky.social",              # cuenta abandonada; la oficial es uc3m.es
    "cucagamarra.bsky.social",       # 32 followers, sin bio, no verificable
    "migueldelarl.bsky.social",      # persona distinta al diputado PP
    # Personas distintas al político asignado
    "sagutierrezz.bsky.social",      # investigador en genómica, no el diputado PP
    "luisgomezmx.bsky.social",       # persona en México, no el diputado
    "isabeliniesta.bsky.social",     # profesora con apellido distinto (Iniesta Alemán)
    "juanruizlorenzo.bsky.social",   # profesor de física teórica, no el diputado
    "carmenmartinez.bsky.social",    # periodista con apellido distinto (Martínez Sánchez)
    "rafaellemus.bsky.social",       # escritor latinoamericano, no el senador
    "josanlatorre.bsky.social",      # experto en AAPP, no el senador
    "margaprohens.bsky.social",      # bio dice explícitamente "Cuenta fake"
}
